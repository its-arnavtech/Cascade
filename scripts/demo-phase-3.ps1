...
try {
    Write-Section "Phase 3 Demo Health"
    ...
    Write-Section "Create Phase 3 Demo Experiment"
    Start-PF "experiment-tracker-service" "8002:8002"
    try { $experiment = HttpJson POST "http://localhost:8002/experiments" @{ experiment_type = "phase-3-demo"; target_service = "cartservice"; namespace = "cascade-targets"; duration_seconds = 30; chaos_mesh_resource = "phase-3-demo" } } finally { Stop-PF }
