...
try {
    Write-Section "Phase 3 Acceptance"
    ...
    try {
        $experiment = HttpJson POST "http://localhost:8002/experiments" @{ experiment_type = "phase-3-acceptance"; target_service = "cartservice"; namespace = "cascade-targets"; duration_seconds = 30; chaos_mesh_resource = "phase-3-acceptance" } 10
