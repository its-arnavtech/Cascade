...
try {
    Write-Section "Phase 4 Demo Health"
    ...
    try {
        ...
        if ($Synthetic) {
            Write-Host "Inserting clearly labeled synthetic Phase 4 demo anomaly window."
    ...
    try {
        ...
        if ($Synthetic) {
            $detectBody["service"] = "phase4-synthetic-service"
        }
