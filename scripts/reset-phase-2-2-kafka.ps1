...
Write-Section "Reset Phase 2.2 Kafka Kubernetes Resources"
Write-Host "Cluster: $ClusterName"
Write-Host "Namespace: $Namespace"
Write-Host "This script deletes active Kafka and stream-enricher Kubernetes resources only."
...
Write-Section "3. Delete Active Broken Kafka Resources"
...
Write-Section "4. Delete Active Stream Enricher Resources"
...
Write-Section "5. Preserve Observation Service"
...
Write-Host ""
Write-Host "Reset complete. Rebuild/load images before applying Phase 2.2 manifests if the cluster was recreated."
